...
<div class="container" style="text-align: center;">
  <div class="figure">
    <div class="row">
        ...
        <div class="col-md-3 ">
          <figure class="figure">
              <img src="<?php echo $row['upload_img']; ?>" id="<?php echo $row['id']; ?>_image" class=" figure-img  img-thumbnail rounded" alt="problem image">
          </figure>
        </div>
        ...
        <div class = "vertical"></div>
            ...
            <div class=" col-md-5">
                ...
                <button style="margin-top: 20px;" class="btn btn-light btn-block"> Transport within <p style="color: red;"><strong> Albania </strong><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/></svg></p>
                </button>
